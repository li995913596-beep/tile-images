...
function ensureAdminTableStyle(){
  ...
  st.textContent =
    ...
    ".ta-head-actions{margin-left:auto;display:flex;gap:6px;flex-wrap:wrap;}" +
...
export function renderAdminList(list){
  ...
  groups.forEach(function(g, gi){
    ...
    head.innerHTML =
      ...
      '<button type="button" class="btn-del-bl" data-bl="' + esc(g.blNo) + '">删除整个提单</button>' +
      "</span>";
