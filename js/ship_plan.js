  ...
  return (
    ...
    '<div style="padding:14px;border-radius:12px;background:#f8fafc;border:1px solid #e2e8f0;margin-bottom:14px;">' +
      '<div style="display:flex;flex-wrap:wrap;gap:8px;align-items:center;margin-bottom:8px;">' +
        ...
        '<button type="button" id="sp_btn_clear" style="margin-left:auto;padding:4px 10px;border:1px solid #d1d5db;background:#fff;color:#374151;border-radius:6px;cursor:pointer;font-size:12px;font-weight:600;">清空明细</button>' +
      "</div>" +
...
function boot(){
  ...
  console.log("ship_plan.js ready v20260815i (front+admin, local cache)");
}
