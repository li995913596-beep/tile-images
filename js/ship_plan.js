  ...
  tab.innerHTML =
    ...
    '<div style="display:grid;gap:12px;margin-bottom:14px;">' +
      ...
      '<div>' +
        ...
        '<textarea id="sp_vehicle" rows="4" placeholder="直接粘贴车牌/吨位/电话等（已含标题的整段文字即可）" style="width:100%;box-sizing:border-box;padding:10px;border:1px solid #d1d5db;border-radius:10px;font-size:13px;line-height:1.45;resize:vertical;"></textarea>' +
      '</div>' +
      '<div>' +
    ...
    '<div style="padding:14px;border-radius:12px;background:#f8fafc;border:1px solid #e2e8f0;margin-bottom:14px;">' +
      '<div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px;margin-bottom:8px;">' +
        ...
        '<button type="button" id="sp_btn_clear" style="padding:5px 12px;border:1px solid #d1d5db;background:#fff;color:#374151;border-radius:6px;cursor:pointer;font-size:12px;font-weight:600;">清空明细</button>' +
      '</div>' +
...
function boot(){
  ...
  console.log("ship_plan.js ready v20260815a");
}
