  ...
  tab.innerHTML =
    ...
    '<div style="display:grid;gap:12px;margin-bottom:14px;">' +
      ...
      '<div>' +
        ...
        '<textarea id="sp_vehicle" rows="4" placeholder="例如：&#10;รถ 10.9 ตัน ราคา 6300 บาท&#10;71-3907&#10;โทร 064-6984344 วันเฉลิม" ' +
          'style="width:100%;box-sizing:border-box;padding:10px;border:1px solid #d1d5db;border-radius:10px;font-size:13px;line-height:1.45;resize:vertical;"></textarea>' +
      '</div>' +
      '<div>' +
        '<div style="font-size:13px;font-weight:600;margin-bottom:4px;color:#374151;">文末备注（可空，默认「送货单一起带过去」）</div>' +
    ...
    '<div style="padding:14px;border-radius:12px;background:#f0fdfa;border:1px solid #99f6e4;margin-bottom:14px;">' +
      '<div style="font-weight:600;margin-bottom:8px;color:#0f766e;">① 搜索库存并加入计划</div>' +
    ...
    '<div style="padding:14px;border-radius:12px;background:#f8fafc;border:1px solid #e2e8f0;margin-bottom:14px;">' +
      '<div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:8px;margin-bottom:8px;">' +
        '<div style="font-weight:600;color:#1f2937;">② 本单明细</div>' +
...
function boot(){
  ...
  console.log("admin_ship_plan.js ready");
}
